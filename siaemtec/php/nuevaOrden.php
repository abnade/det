...
/*------ Preguntar por el estado del Equipo esta en dictamen -----------------*/

$sqlEdoFuncional="SELECT ESTADO FROM equipoinventario WHERE NO_CONTROL ='$NOCONTROL'";
$EdoFuncional=getArraySQL($sqlEdoFuncional);

if($EdoFuncional[0]['ESTADO']=='DICTAMEN'){
$insertGoTo='error3.php';
}else{ // Else estado
