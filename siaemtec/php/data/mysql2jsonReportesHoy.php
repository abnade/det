...
$sql = "SELECT *, CONCAT(FECHA,' ',HORA) AS FECHA_HORA,TIMESTAMPDIFF(MINUTE,CONCAT(FECHA,' ',HORA), NOW()) as DIF_MIN FROM reportes WHERE ATENDIDO IS NULL OR ATENDIDO=0 ORDER BY FECHA AND HORA DESC" ;
function connectDB(){
